...
int main(){
    ...
    for(int turn=0; turn<1000000; turn++){
        ...
        if(ti == 0 || ti == N-1 || tj == 0 || tj == N-1){
            if (ti == 0 && tj < N/2) {
                //花を(0,0)としたとき、(0,1),(0,-1),(0,-3),(1,3),(1,1),(1,-3),(2,3),(2,0),(2,-1),(2,-3),(3,-2),(3,-3),(4,1),(4,0),(4,-1),(4,-2)\にトレントを置く
                places = {{0,1},{0,-1},{0,-3},{1,3},{1,1},{1,-3},{2,3},{2,0},{2,-1},{2,-3},{3,-2},{3,-3},{4,1},{4,0},{4,-1},{4,-2}};
            }else if (ti == 0 && tj >= N/2) {
                //ti == 0 && tj < N/2の場合のy座標の正負を反転
                places = {{0,-1},{0,1},{0,3},{1,-3},{1,-1},{1,3},{2,-3},{2,0},{2,1},{2,3},{3,2},{3,3},{4,-1},{4,0},{4,1},{4,2}};
                ...
                //ti == 0 && tj < N/2の場合のx,y座標を入れ替える
                places = {{1,0},{-1,0},{-3,0},{3,1},{1,1},{-3,1},{3,2},{0,2},{-1,2},{-3,2},{-2,3},{-3,3},{1,4},{0,4},{-1,4},{-2,4}};
            }else if (tj == 0 && ti >= N/2) {
                //tj == 0 && ti < N/2のx座標の正負を反転
                places = {{-1,0},{1,0},{3,0},{-3,1},{-1,1},{3,1},{-3,2},{0,2},{1,2},{3,2},{2,3},{3,3},{-1,4},{0,4},{1,4},{2,4}};
